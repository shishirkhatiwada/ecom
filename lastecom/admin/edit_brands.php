...
if(isset($_POST['edit_brand'])){
    // Handle the brand update here based on the form data.
    $brand_title = $_POST['brand_title'];

    // Use an UPDATE SQL query to update the brand title in the database.
        ...
        <div class="col-md-8 offset-md-2"> <!-- Adjust width and center content -->
            <form class="awesome-form" action="" method="POST">
                <div class="form-group">
                    <label for="" class="text-success mt-3">Brand</label>
                </div>
                <div class="form-group">
                    <input type="text" class="form-control" id="name" name="brand_title" placeholder="Category Name" required="required" value="<?php echo $brand_title; ?>">
                </div>
                <button type="submit" class="btn btn-block btn-primary m-4" name="edit_brand">Submit</button>
            </form>
        </div>
    </div>
</div>
